      ...
      <div className="containerCarrito">
            ...
            carrito.map((i) => (
              <li className="itemInCart" key={i.id}>
                ...
                <div className="priceItemInCart">
                  <p>
                    Precio: {i.price * i.cantidad} ETH{" "}
                    <img src="https://img.icons8.com/ios/25/000000/ethereum.png" />
                  </p>
                  <p>
                    Precio en USD:{" "}
                    {<ValorMoneda precioEnEth={i.price * i.cantidad} />} $USD
                  </p>
                </div>
                {/* Agregar funcionalidad a este boton */}
                <button
                  className="btn btn-light deleteItem"
        ...
        <div className="infoGeneralCarrito">
          <div className="precios">
            <p>
              Total en ETH: {totalEthEnCart.toFixed(5)}{" "}
              {totalEthEnCart ? (
                <img
                  src="https://img.icons8.com/ios/35/FFFFFF/ethereum.png"
                  className="signoEth"
                />
              ) : (
                ""
            ...
            <p>
              Total en USD: {<ValorMoneda precioEnEth={totalEthEnCart} />} $USD{" "}
            </p>
          </div>
